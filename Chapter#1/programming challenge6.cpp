...
int main()
{
	float payAmount = 2200.0;//This variable will hold the amount of pay the employee earns each
							 //pay period. Initialize the variable with 2200.0.
	float payPeriods = 26.0;//This variable will hold the number of pay periods in a year
	float annualPay;//This variable will hold the employee’s total annual pay
					//i.e (payAmount * payPeriods)
					//So
	annualPay = payAmount * payPeriods;//Total annual pay of the employee
	cout << "The total annual pay of the employee is equal to : " << annualPay;
